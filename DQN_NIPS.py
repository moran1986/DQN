...
class BrainDQN:
	...
	def createQNetwork(self):
		# network weights
		W_conv1 = self.weight_variable([3,3,16,16])
		...
		self.stateInput = tf.placeholder("float",[None,17,17,16])

		# hidden layers
		h_conv1 = tf.nn.relu(self.conv2d(self.stateInput,W_conv1,1) + b_conv1)
